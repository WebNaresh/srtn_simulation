    ...
    <Card className="overflow-hidden border-none shadow-lg">
      ...
      <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-slate-700 flex gap-2">
            ...
            <div>
              <h4 className="font-medium text-cyan-700 mb-2 flex items-center gap-1">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-6 rounded-xl border border-purple-100">
          <h3 className="text-xl font-semibold text-purple-800 mb-3">What is SRTN?</h3>
        ...
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-xl border">
          <h3 className="text-xl font-semibold text-slate-800 mb-3">Advantages & Disadvantages</h3>
